...
```{r, echo=FALSE, warning=FALSE, message=TRUE, error=TRUE}
 cases_Map
```
Texas has one of the highest rates of incarceration. In Texas, there are around 135 000 convicts.  Dissecting the prisoner’s population by county makes it easier to understand which place has the highest incarceration rate and ask the question if it is related to the biased prison system. Do we have sufficient evidence to infer that the system is unequal based on this map?
